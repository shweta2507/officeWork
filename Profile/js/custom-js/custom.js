...
$('.edit-profile-drowpdown>ul>li>ul>li.change-pass').click(function() {
    $('.edit-profile').hide();
    $('.edit-profile.password-change').show();
});
$('.edit-profile-drowpdown>ul>li>ul>li.upload-img').click(function() {
    $('.edit-profile').hide();
    $('.upload-img-wrapper').show();
});
$('.closeIcon').click(function() {
    $('button.btn.btn-primary[data-target="#exampleModal"]')[0].click();
});
$('button.btn.btn-primary[data-target="#exampleModal"]').click(function() {
    $('.edit-profile').show();
    $('.upload-img-wrapper, .edit-profile.password-change').hide();
});
// Show Hide Password
...
$('.form-button .for-btn.for-btn-primary:not(.btn-blue)').click(function() {
    $('button.btn.btn-primary[data-target="#exampleModal"]')[0].click();
});

$('.edit-profile .gernal-profile .form-control:not(.no-required)').focusout(function(ele) {
    setTimeout(function() {
...
/*
            ...
            ===============    Profile Photo Resize and Crop JS    =====================
